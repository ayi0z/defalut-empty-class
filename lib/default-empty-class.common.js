...
var install = function install(Vue) {
  ...
  Vue.directive('empty-class', {
    ...
    componentUpdated: function componentUpdated(el, binding, vnode) {
      ...
      var vmo = vnode.data.directives.find(function (d) {
        return d.rawName == 'v-model';
      });

      if (vmo) {
        var vmoExp = vmo.expression;
      ...
      if (typeof binding.value == 'string') {
        var classname = binding.value || 'default-empty-class',
...
/******/ });
//# sourceMappingURL=default-empty-class.common.js.map